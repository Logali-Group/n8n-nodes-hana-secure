...
> Status: release candidate `0.2.0`. Connection, catalog, metadata, and guarded structured reads
...
```bash
docker cp n8n-nodes-hana-secure-0.2.0.tgz <n8n-container>:/tmp/

docker exec -u node -it <n8n-container> sh
mkdir -p /home/node/.n8n/nodes
cd /home/node/.n8n/nodes
npm install --omit=dev /tmp/n8n-nodes-hana-secure-0.2.0.tgz
exit
