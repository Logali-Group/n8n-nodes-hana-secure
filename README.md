...
> Status: `0.9.7` is the current public npm release with provenance and installs by name on
...
```bash
docker cp n8n-nodes-hana-secure-0.9.7.tgz <n8n-container>:/tmp/

docker exec -u node -it <n8n-container> sh
mkdir -p /home/node/.n8n/nodes
cd /home/node/.n8n/nodes
npm install --omit=dev /tmp/n8n-nodes-hana-secure-0.9.7.tgz
exit
